            ...
            <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light mf:w-9/12 w-11/12 text-base">
                        Explore the Crypto World.. Buy and Sell cryptocurrencies easily on CryptoPe
                    </p>
                    {!currentAccount && (
                    <button 
                        type="button"
                        onClick={connectWallet}
                        className="flex flex-grow justify-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
                    >
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={commonStyles}>Secruity</div>
                        <div className={'rounded-tr-2xl min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white'}>Etherium</div>
                        <div className={'rounded-bl-2xl min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white'}>Web3.O</div>
